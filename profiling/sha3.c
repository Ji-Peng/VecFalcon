...
#    define yy_rotl(yv, nn)                        \
        _mm256_or_si256(_mm256_slli_epi64(yv, nn), \
                        _mm256_srli_epi64(yv, 64 - (nn)))
#    define yy_andnotL(a, b) _mm256_andnot_si256(a, b)
#    define yy_xor(a, b) _mm256_xor_si256(a, b)

#    define yCOMB1(yd, i0, i1, i2, i3, i4, i5, i6, i7, i8, i9) \
        do {                                                   \
...
#    define yCOMB2(i0, i1, i2, i3, i4, op0, op1, op2, op3, op4) \
        do {                                                    \
...
/* This is a variant of the AVX2 process_block_x4() function, but with
   ...
   interleaved). */
TARGET_SSE2
static void process_block_x2(uint64_t *A)
{
    __m128i xa[25];
...
#    define xx_rotl(xv, nn) \
        _mm_or_si128(_mm_slli_epi64(xv, nn), _mm_srli_epi64(xv, 64 - (nn)))
#    define xx_andnotL(a, b) _mm_andnot_si128(a, b)
#    define xx_xor(a, b) _mm_xor_si128(a, b)

#    define xCOMB1(xd, i0, i1, i2, i3, i4, i5, i6, i7, i8, i9) \
        do {                                                   \
...
#    define xCOMB2(i0, i1, i2, i3, i4, op0, op1, op2, op3, op4) \
        do {                                                    \
...
void shake_extract(shake_context *sc, void *out, size_t len)
{
    ...
    while (len > 0) {
        ...
        if (buf != NULL) {
            while (clen-- > 0) {
                *buf++ = (uint8_t)(sc->A[dptr >> 3] >> ((dptr & 7) << 3));
                dptr++;
            }
        } else {
            dptr += clen;
